...
from .validators import validation_icon_image_size, validate_image_file_extension
...
class Category(models.Model):
  ...
  # if category is deleted icon file is also deleted
...
class Channel(models.Model):
  ...
  icon = models.ImageField(
    ...
    null=True, 
    blank=True, 
    validators=[validation_icon_image_size, validate_image_file_extension]
    )
